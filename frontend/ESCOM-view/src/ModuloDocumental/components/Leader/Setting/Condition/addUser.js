...
import { getListUser, associateUserCondition } from '../../../../redux/actions/userConditionA.js';
...
export default withRouter(connect(mapStateToProps, { getListUser, associateUserCondition })(formAdd));
